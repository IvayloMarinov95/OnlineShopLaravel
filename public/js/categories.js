...
function createNewCategory(event){
    ...
    ajax("POST", "/admin/shop/categories/create", "name=" + name, newCategoryCreated, [name]);
}
...
function saveEdit(event){
    ...
    ajax("POST", "/admin/shop/categories/update", "name=" + categoryName + "&category_id=" + categoryId, endEdit, [event]);
}
...
function deleteCategory(){
    ...
    var categoryId = event.path[4].previousElementSibling.dataset['id'];
    ajax("GET", "/admin/shop/category/" + categoryId + "/delete", null, categoryDeleted, [event.path[5]]);
}
